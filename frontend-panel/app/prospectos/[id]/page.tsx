...
function buildWhatsappContactUrl(phone: string | null, name: string | null) {
  if (!phone) return null;

  const message = `Hola ${name ?? ""}, te contactamos de VA Decoraciones para dar seguimiento a tu cotización.`;
      ...
      <section className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
          ...
          <section className="mb-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <form action={updateLeadNotes} className="mt-4">
              <input type="hidden" name="leadId" value={lead.id} />
              ...
              <textarea
                ...
                placeholder="Escribe notas de seguimiento para este prospecto..."
              />
